...
const points = [
  "Quick and hassle-free registration with your own mahadev777 ID.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
            Get Your <span className="text-gold-gradient">mahadev777 ID</span> & Start Today
          </h2>
          <p className="text-foreground/70 mb-8">
            mahadev777 is India's most trusted platform for online gaming. It's built to be simple, safe, and fast — so whether you're new or experienced, getting started is easy.
          </p>
          ...
          <p className="text-foreground/70 text-sm mb-8">
            Thousands of players already trust mahadev777 for transparent and secure play. You can join them today by downloading the app or using the website.
          </p>
